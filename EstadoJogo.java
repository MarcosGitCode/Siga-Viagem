public class EstadoJogo {
    public static boolean luzesApagadas = false;
    public static boolean chaveInserida = false;
    public static boolean portaFechada = false;
    public static boolean portaAdesivo = false;
